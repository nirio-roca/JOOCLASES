...
public class CVenta {
    ...
    public CVenta( String tipoDocumento, String nroDocumento, Date fechaVenta, String idVendedor, String idCliente, double precioTotal, double igv, double descuento, String estado) {
